...
namespace SPTr.DeveloperConsole
{
    ...
    public static class DevConsole
    {
        ...
        private static readonly ConsoleCommand info_execflags = new ConsoleCommand("info_execflags", () => { },
        ...
        private static readonly ConsoleCommand flag_cheats = new ConsoleCommand("flag_cheats",
        (bool value) =>
        {
            if (value)
